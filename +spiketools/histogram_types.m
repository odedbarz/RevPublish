...
t = {'none', 'PST', 'Interval', 'Period', 'Autocorrelation', 'Crosscorrelation', ...
     'Recurrence', 'ShuffledCorrelation', 'Latency', 'Revcor', ...
     'PST Raster', 'Interval Raster', 'Period Raster', 'Autocorrelation Raster', 'Crosscorrelation Raster', ...
     'PST-Interval', 'PST-Period', 'PST-Autocorrelation', 'PST-Crosscorrelation', 'PST-ShuffledCorrelation', ...
